...
import genomicswordcount.mercount.MerCount;
 ...
 * @author iychoi
 */
public class GenomicsWordCount {

    private static final Log LOG = LogFactory.getLog(GenomicsWordCount.class);
    ...
    private static void printHelp() {
        System.out.println("============================================================");
        System.out.println("Genomics Word Count");
        System.out.println("============================================================");
        System.out.println("Usage :");
        System.out.println("> gwc <command> <arguments ...>");
        System.out.println();
